...
Draggable.create(".button", {type: "rotation", throwProps: true});
...
TweenLite.set("#zoom", {width:gridWidth, height:gridHeight, lineHeight:gridHeight + "px"});

//the update() function is what creates the Draggable according to the options selected (snapping).
function update() {
  var snap = $snap.prop("checked"),
      liveSnap = $liveSnap.prop("checked");
	Draggable.create("#zoom", {
		bounds:$zoomwrapper,
		edgeResistance:0.65,
		type:"x,y",
		throwProps:true,
